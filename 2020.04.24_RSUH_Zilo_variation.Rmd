...
date: |
    ...
    |
    | Presentation is available here: \alert{tinyurl.com/y78s9jbb}
    |
...
# qrcode_gen("https://github.com/agricolamz/2020.04.24_RSUH_Zilo_variation/raw/master/2020.04.24_RSUH_Zilo_variation.pdf")
# dev.off()
...
In order to measure diversity of the questions we used the easiest measure --- the information entropy, introduced in [@shannon48]:
...
- An **"average researcher"** might overlook a significant amount of the variation we observed due to the low number of speakers they usually consult with (more possible values and lower variable entropy is higher likelyhood of overlooking)
